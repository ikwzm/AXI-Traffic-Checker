...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MR_MONITOR_BITS" -parent ${Main}
  ipgui::add_param $IPINST -name "MW_MONITOR_BITS" -parent ${Main}
  ...
  #Adding Group
  set Master_Read_Configuration [ipgui::add_group $IPINST -name "Master Read Configuration" -parent ${Master_I/F}]
  ipgui::add_param $IPINST -name "MR_MAX_XFER_SIZE" -parent ${Master_Read_Configuration}
  ipgui::add_param $IPINST -name "MR_QUEUE_SIZE" -parent ${Master_Read_Configuration}
  ipgui::add_param $IPINST -name "MR_ACK_REGS" -parent ${Master_Read_Configuration}
  ipgui::add_param $IPINST -name "MR_DATA_REGS" -parent ${Master_Read_Configuration}
  ipgui::add_param $IPINST -name "MR_DATA_PIPELINE" -parent ${Master_Read_Configuration}
